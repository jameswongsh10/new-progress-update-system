        ...
        <div class="card-body">
            <div class="row">
                ...
                <form autocomplete="off" method="post" action="#">
                    <div class="form-group">
                        <label>1. </label>
                        <label>
                            <select name="firstOption" class="form-control">
                    ...
                    <div class="form-group">
                        <label>2. </label>
                        <label>
                            <select name="secondOption" class="form-control">
                                <option value="first">First</option>
                                <option value="second">Second</option>
                            </select>
                        </label>
                    ...
                    <div class="form-group">
                        <label>3. </label>
                        <label>
                            <select name="thirdOption" class="form-control">
                                <option value="first">First</option>
                                <option value="second">Second</option>
                            </select>
                        </label>
                    ...
                    <div class="form-group">
                        <label>4. </label>
                        <label>
                            <select name="fourthOption" class="form-control">
                                <option value="first">First</option>
                                <option value="second">Second</option>
                            </select>
                        </label>
            ...
            <div class="row">
                <div class="table-responsive">
                    ...
                    <a href="#" class="btn btn-sm btn-success">Add Team</a>
                </div>
            </div>
