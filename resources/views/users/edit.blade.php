                            ...
                            @foreach($teams as $team)
                                @foreach($urlTeams as $urlTeam)
                                    <option value="{{$team->id}}"
                                            @if($urlTeam->id == $team->id) selected @php $selected = true; @endphp @else @php $selected = false; @endphp @endif >@if($selected == true) {{$urlTeam->team_name}} @else{{$team->team_name}} @endif</option>
                                @endforeach
                            @endforeach
                        </select>
