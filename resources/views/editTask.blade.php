            ...
            <div class="card-body">
                ...
                <form autocomplete="off" method="post" action="{{ route('updateTask', $task->id) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input autocomplete="off" disabled name="title" class="form-control"
                        ...
                        <select name="status" class="form-control">
                            ...
                            @foreach($statuses as $status)
                                @foreach($statusTask as $individualStatusTask)
                                    <option value="{{$status->html_name}}"
                                            @if($individualStatusTask->status_id == $status->id) selected @endif>{{$status->status_title}}</option>
                                @endforeach
                            @endforeach
                        </select>
