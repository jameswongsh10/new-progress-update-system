...
{
    /**
     * This function get a date from its parameter $created_at, which is a start date for the whole week.
     * The function will generate a set of report data of the week and pass it to the report.blade.php to create a preview of the question report.
     * The question report contains question that asked by admin, and the user's answer to it.
     *
     * @param $created_at
    ...
    /**
     * This function will export the report generated by the above function in PDF format.
     */
    public function pdf()
    {
